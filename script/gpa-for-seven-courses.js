...
calculateGpaButton.btnForSevenCourses.addEventListener('click', () => {
    ...
    document.getElementById('gpa-btn3').style.display = 'none'
    ...
    var totalGPA = (((Y1*1) + (Y2*1) + (Y3*1) + (Y4*1) + (Y5*1) + (Y6*1) + (Y7*1) ) / (7*1)).toFixed(1)
