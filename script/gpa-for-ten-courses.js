...
calculateGpaButton.btnForTenCourses.addEventListener('click', () => {
    ...
    document.getElementById('gpa-btn6').style.display = 'none'
    ...
    var totalGPA = (((Y1*1) + (Y2*1) + (Y3*1) + (Y4*1) + (Y5*1) + (Y6*1) + (Y7*1) + (Y8*1) + (Y9*1) + (Y10*1) ) / (10*1)).toFixed(1)
