...
calculateGpaButton.btnForElevenCourses.addEventListener('click', () => {
    ...
    document.getElementById('gpa-btn7').style.display = 'none'
    ...
    var courseWork10Value = document.getElementById('input-course-work10').valueAsNumber
    var ue10Value = document.getElementById('input-final10').valueAsNumber
    var totalMarksForCourse10 = courseWork10Value + ue10Value

    if (totalMarksForCourse10 > 100) {
        alert('Maksi za kozi ya Kumi zimezidi 100. Tafadhali weka Maksi sahihi')
    }
    else if (totalMarksForCourse10 >= 70) {
        var Y10 = ((0.02 * totalMarksForCourse10) + 3).toFixed(1)
    }
    else if (totalMarksForCourse10 >= 65) {
        Y10 = ((0.08 * totalMarksForCourse10) - 1.2).toFixed(1)
    }
    else if (totalMarksForCourse10 >= 60) {
        Y10 = ((0.2 * totalMarksForCourse10) - 9).toFixed(1)
    }
    else if (totalMarksForCourse10 >= 50) {
        Y10 = ((0.1 * totalMarksForCourse10) - 3).toFixed(1)
    }
    else if (totalMarksForCourse10 >= 40) {
        Y10 = ((0.1 * totalMarksForCourse10) - 3).toFixed(1)
    }
    else if (totalMarksForCourse10 >= 0) {
        Y10 = (0.025 * totalMarksForCourse10).toFixed(1)
    }
    else if (totalMarksForCourse10 < 0) {
        alert('Maksi za kozi ya Kumi zipo chini ya "0". Tafadhali weka Maksi sahihi')
    }

    //Kozi ya 11

    var courseWork11Value = document.getElementById('input-course-work11').valueAsNumber
    var ue11Value = document.getElementById('input-final11').valueAsNumber
    var totalMarksForCourse11 = courseWork11Value + ue11Value

    if (totalMarksForCourse11 > 100) {
        alert('Maksi za kozi ya 11 zimezidi 100. Tafadhali weka Maksi sahihi')
    }
    else if (totalMarksForCourse11 >= 70) {
        var Y11 = ((0.02 * totalMarksForCourse11) + 3).toFixed(1)
    }
    else if (totalMarksForCourse11 >= 65) {
        Y11 = ((0.08 * totalMarksForCourse11) - 1.2).toFixed(1)
    }
    else if (totalMarksForCourse11 >= 60) {
        Y11 = ((0.2 * totalMarksForCourse11) - 9).toFixed(1)
    }
    else if (totalMarksForCourse11 >= 50) {
        Y11 = ((0.1 * totalMarksForCourse11) - 3).toFixed(1)
    }
    else if (totalMarksForCourse11 >= 40) {
        Y11 = ((0.1 * totalMarksForCourse11) - 3).toFixed(1)
    }
    else if (totalMarksForCourse11 >= 0) {
        Y11 = (0.025 * totalMarksForCourse11).toFixed(1)
    }
    else if (totalMarksForCourse11 < 0) {
        alert('Maksi za kozi ya 11 zipo chini ya "0". Tafadhali weka Maksi sahihi')
    }

    var totalGPA = (((Y1*1) + (Y2*1) + (Y3*1) + (Y4*1) + (Y5*1) + (Y6*1) + (Y7*1) + (Y8*1) + (Y9*1) + (Y10*1) + (Y11*1) ) / (11*1)).toFixed(1)
